#
#  Be sure to run `pod spec lint JVSPlayerSDK.podspec.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "zhangxiaodong"
  # spec.authors            = { "zhangxiaodong" => "zhangxiaodong@jovision.com" }
  # spec.social_media_url   = "https://twitter.com/zhangxiaodong"
